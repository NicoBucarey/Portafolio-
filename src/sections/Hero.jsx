      ...
      <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-10 md:gap-12 items-center">
        ...
        <div className="flex justify-center">
          <div className="relative group">
            ...
            <div
              className={`relative w-72 h-72 md:w-80 md:h-80 rounded-full overflow-hidden border-4 transition-all duration-500 group-hover:scale-105 ${
                isLightMode
            ...
            >
              ...
              <img
                src={profileOscuroImg}
                alt="Foto de perfil en modo claro"
                className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ${
